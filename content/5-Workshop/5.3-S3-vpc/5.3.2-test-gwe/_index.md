...
![CDK deployment completed](/5-workshop/images/cloudbrief-evidence/cdk-deploy-ok.png)
...
![Step 5.1 CloudFormation](/5-workshop/images/cloudbrief-evidence/cli-cloudformation.png)
...
![Step 5.2 EC2 workers](/5-workshop/images/cloudbrief-evidence/cli-ec2-workers.png)
...
![Step 5.3 Auto Scaling group](/5-workshop/images/cloudbrief-evidence/cli-asg.png)
...
![Step 5.4 ALB](/5-workshop/images/cloudbrief-evidence/cli-alb.png)
...
![Step 5.5 NAT Gateway](/5-workshop/images/cloudbrief-evidence/cli-nat-gateway.png)
...
![Step 5.6 VPC endpoints](/5-workshop/images/cloudbrief-evidence/cli-vpc-endpoints.png)
...
![Step 5.7 CloudFront](/5-workshop/images/cloudbrief-evidence/cli-cloudfront.png)
...
![Step 5.8 AWS WAF](/5-workshop/images/cloudbrief-evidence/cli-waf.png)
...
![Step 5.9 S3 buckets](/5-workshop/images/cloudbrief-evidence/cli-s3-buckets.png)
...
![Step 5.10 DynamoDB](/5-workshop/images/cloudbrief-evidence/cli-dynamodb.png)
...
![Step 5.11 SQS](/5-workshop/images/cloudbrief-evidence/cli-sqs.png)
...
![Step 5.12 Bedrock Nova Micro](/5-workshop/images/cloudbrief-evidence/cli-bedrock-nova-micro.png)
