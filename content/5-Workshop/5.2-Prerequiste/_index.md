...
The operator who prepares the workshop account must grant the deployment user permission to create and remove the CloudBrief stack. [Download the policy JSON](/5-workshop/files/cloudbrief-workshop-deployer-policy.json) as `cloudbrief-workshop-deployer-policy.json`, or save the following document with that filename.
...
![Open the IAM user list](/5-workshop/images/5.2-Prerequisite/iam-01-existing-user.png)

Enter a dedicated workshop user name. Console access is optional when the AWS CLI is the primary deployment tool.

![Specify the IAM user details](/5-workshop/images/5.2-Prerequisite/iam-02-user-details.png)
...
![Attach deployment permissions](/5-workshop/images/5.2-Prerequisite/iam-03-permissions.png)

Review the user and policy before choosing **Create user**.

![Review the IAM user](/5-workshop/images/5.2-Prerequisite/iam-04-review-create.png)

Confirm that the new user appears in the IAM user list.

![IAM user created](/5-workshop/images/5.2-Prerequisite/iam-05-user-created.png)

#### 4. Create CLI credentials

Open the user's **Security credentials** tab and choose **Create access key**.

![Open security credentials](/5-workshop/images/5.2-Prerequisite/iam-06-security-credentials.png)

Choose **Command Line Interface (CLI)**, acknowledge the recommendation, and continue.

![Choose the CLI use case](/5-workshop/images/5.2-Prerequisite/iam-07-cli-use-case.png)

Add a description tag so the key has a clear owner and purpose.

![Add an access-key description](/5-workshop/images/5.2-Prerequisite/iam-08-key-description.png)
...
![Access key created with values redacted](/5-workshop/images/5.2-Prerequisite/iam-09-key-created.png)
